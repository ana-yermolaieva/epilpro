    ...
    <section className="main-slide" key="sale-slide">
        ...
        <div className="main-slide__box">
            <div className="main-slide__img-box">
                <img className="main-slide__img" src={saleSlide} alt={t("зображення")}/>
            </div>
            <div className="main-slide__info">
                ...
                <Link to={Data.USER_CONTACTS.inst} className="main-slide__btn btn" target="_blank" rel="noreferrer" aria-label={t("перейти в instagram")} >{t("перейти в instagram")}</Link>
            </div>
        </div>
    </section>
    </>
